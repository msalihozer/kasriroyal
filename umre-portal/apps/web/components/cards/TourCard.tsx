                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative animate-fadeIn">
                        ...
                        <div className="p-8">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 mb-8">
                                <div className="border rounded-xl p-6 text-center">
                                    <PlaneTakeoff className="mx-auto mb-3 text-emerald-600" size={32} />
                                    <div className="text-sm text-gray-500 mb-1">Gidiş</div>
                                    <div className="font-bold text-lg mb-1">{startDate ? startDate.full : 'Tarih Sorunuz'}</div>
                                    <div className="text-sm text-gray-500">İstanbul - Medine</div>
                                </div>
                                <div className="border rounded-xl p-6 text-center bg-gray-50 flex flex-col justify-center">
                                ...
                                <div className="border rounded-xl p-6 text-center">
                                    <PlaneLanding className="mx-auto mb-3 text-emerald-600" size={32} />
                                    <div className="text-sm text-gray-500 mb-1">Dönüş</div>
                                    <div className="font-bold text-lg mb-1">{returnDate ? returnDate.full : 'Tarih Sorunuz'}</div>
                                    <div className="text-sm text-gray-500">Cidde - İstanbul</div>
                                </div>
                            </div>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                    {(tour.pricing ? [
                                        ...
                                        <div key={i} className="border rounded-xl p-4 text-center hover:border-emerald-500 transition-colors cursor-default">
                                            <div className="text-xs text-gray-500 mb-2">{price.label}</div>
                                            <div className="font-bold text-emerald-600 text-lg">{price.price}</div>
                                            <div className="text-[10px] text-gray-400 mt-1">{price.note}</div>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="flex gap-4 p-4 border rounded-xl">
                                        <img src="https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?auto=format&fit=crop&q=80&w=150&h=150" className="w-24 h-24 rounded-lg object-cover" alt="Medine" />
                                        <div>
                                            <div className="font-bold mb-1">Medine Oteli</div>
                                            <div className="text-sm text-gray-600 mb-2">3 Gece • Biltmore (Eski Oberoi)</div>
                                            <div className="text-yellow-400 text-sm">★★★★★</div>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 p-4 border rounded-xl">
                                        <img src="https://images.unsplash.com/photo-1565552629477-e254f39b1a08?auto=format&fit=crop&q=80&w=150&h=150" className="w-24 h-24 rounded-lg object-cover" alt="Mekke" />
                                        <div>
                                            <div className="font-bold mb-1">Mekke Oteli</div>
                                            <div className="text-sm text-gray-600 mb-2">{tour.durationDays - 3} Gece • Raffles Suites</div>
                                            <div className="text-yellow-400 text-sm">★★★★★</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="bg-gray-50 px-8 py-4 border-t flex justify-end">
                            <button
                                onClick={() => setShowModal(false)}
                                className="px-6 py-2 border rounded-lg hover:bg-gray-100 text-gray-700 font-medium"
                            >
                                Kapat
                            </button>
                        </div>
