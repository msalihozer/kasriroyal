...
export default function VipMinimalHero({ title, summary, content }: VipMinimalHeroProps) {
    return (
        <section className="relative w-full bg-[#FAFAFA] pt-16 pb-12 md:pt-20 px-4 flex flex-col items-center justify-center text-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <motion.h1
                    ...
                    className="text-3xl md:text-5xl font-serif font-medium text-gray-900 leading-tight mb-6 md:mb-8"
                >
                    {title}
                </motion.h1>
                ...
                <motion.div
                    ...
                    className="text-base md:text-lg text-gray-500 font-light leading-relaxed max-w-2xl mx-auto"
                >
                    {summary ? (
                        <p>{summary}</p>
                    ) : (
                ...
                {content && (
                    <motion.div
                        ...
                        className="mt-6 md:mt-8 prose prose-base md:prose-lg prose-gray mx-auto text-gray-500"
